  ...
  return (
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <motion.section
        ...
        animate="animate"
        variants={stagger}
        className="relative z-10 pt-20 pb-24 px-4 sm:px-6 lg:px-8"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-8">
            ...
            >
              Accept Any Crypto
              <span className="block text-slate-300 text-4xl sm:text-5xl lg:text-6xl mt-2">
                Settle in One Token
              </span>
            </motion.h1>
            ...
            >
              SETTLE enables merchants to accept payments in any cryptocurrency
              while receiving settlements in their preferred token on their
              chosen blockchain.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div variants={fadeIn} className="text-center mb-20">
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Simplify crypto payments with our seamless, secure, and efficient
              solution
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Receive your preferred token on your chosen blockchain instantly after customer payments",
              ...
              },
              {
                ...
                description:
                  "Built on Chainlink CCIP for secure cross-chain transfers with no intermediaries",
              ...
              },
              {
                ...
                description:
                  "Accept payments from Ethereum, Polygon, Arbitrum, Solana, and more",
              ...
              },
              {
                ...
                description:
                  "Simple widget or API integration. Get started in minutes, not days",
              ...
              },
              {
                ...
                description:
                  "Track transactions, volume, and performance with our comprehensive dashboard",
              ...
              },
              {
                ...
                description:
                  "Customers can pay with any wallet or exchange without creating new accounts",
            ...
            {[
              {
                ...
                description:
                  "Connect your wallet, choose your settlement chain and token, and configure your preferences",
              ...
              },
              {
                ...
                description:
                  "Add our simple widget to your website or use our API for custom implementations",
              ...
              },
              {
                ...
                description:
                  "Customers pay with any crypto, you receive your preferred token automatically",
          ...
          <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-3xl p-12 hover:bg-slate-700/50 transition-all duration-300">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
                Join thousands of merchants already using SETTLE to accept
                crypto payments
              </p>
              <Link href="/onboarding">
                <motion.button
